...
%%% LONGITUDE %%%
\path[tdplot_rotated_coords,very thin,domain=0:360,smooth,variable=\t,spath/save=pathname] plot ({1.5*cos(\t)*cos(\Vthe+\Vspin)},{1.5*cos(\t)*sin(\Vthe+\Vspin)},{1.5*sin(\t)});
...
\draw[white,tdplot_screen_coords] (0,0) circle(8);
