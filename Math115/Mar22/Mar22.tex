...
For questions about areas between curves, Dr. Solomonovich will require that we calculate the points of intersection. A useful visualization trick for integrating with repsect to $y$ is to switch $x$ and $y$, then integrate with respect to $x$. Basically, just redraw the graph, but flipped about $y=x$.
