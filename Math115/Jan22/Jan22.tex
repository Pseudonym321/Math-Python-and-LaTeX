...
As an elaboration to our previous definition of the trigonometric functions, Dr. Solomonovich is now describing them as being "projections" of a line in standard position in a unit circle onto the coordinate axes. For instance, the sine of theta is the vertical projection of the line extending from the origin in standard position at angle theta until it intersects the unit circle.
